const copy = {
  en: {
    ...
    aboutP1: 'I’m an Artificial Intelligence undergraduate at Peking University, expected to graduate in June 2027. I focus on foundation models and agent systems, and enjoy turning ambiguous, real-world tasks into dependable technical products.',
    ...
    workTitle: 'Selected work', workNote: 'Problem framing · architecture · implementation', detailButton: 'Explore the full case study', detailCloseButton: 'Close case study', demoButton: 'Open system demo ↗',
  ...
  zh: {
    ...
    workTitle: '代表工作', workNote: '问题建模 · 系统架构 · 技术实现', detailButton: '展开完整案例', detailCloseButton: '收起案例', demoButton: '查看系统 Demo ↗',
